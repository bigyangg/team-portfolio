    ...
    <section className="relative w-full py-20 md:py-28">
      <div className="mx-auto w-full max-w-[1240px] px-5 md:px-10">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="font-display mt-3 text-[34px] font-bold leading-[1.06] tracking-[-0.022em] text-[var(--text)] sm:text-[44px] md:text-[54px]">
            Five places hydrogen{' '}
            <span className="glow-text">moves the needle</span> for Nepal.
          </h2>
          <p className="mt-5 text-[15.5px] leading-[1.65] text-[var(--text)]/70 md:text-[16.5px]">
        ...
        <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-6 lg:gap-6">
          {USE_CASES.map((u, i) => {
            ...
            return (
              <article
                key={u.n}
                className={`group relative overflow-hidden rounded-[22px] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-6 shadow-[0_8px_28px_rgba(5,46,44,0.06)] backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1 hover:border-[var(--primary)]/50 hover:shadow-[0_24px_48px_-12px_rgba(16,185,129,0.30)] ${lgSpan}`}
              >
                <span
                  aria-hidden="true"
                ...
                <div className="relative">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono tab-num text-[11px] font-medium tracking-[0.12em] text-[var(--muted-foreground)]">
                      № {u.n}
                    </span>
                  </div>
                  <h3 className="font-display mt-5 text-[20px] font-bold leading-tight tracking-[-0.015em] text-[var(--text)]">
                    {u.title}
                  </h3>
