            ...
            >
              ...
              <div className="relative flex items-start justify-between gap-3">
                <div className="flex-1">
                  <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-[var(--glass-border)] bg-[var(--glass-bg-strong)] text-[var(--primary)] backdrop-blur-xl">
                ...
                <ArrowUpRight
                  className="h-4 w-4 shrink-0 -translate-x-1 translate-y-1 text-[var(--muted-foreground)] opacity-60 transition-all duration-300 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:text-[var(--primary)] group-hover:opacity-100"
                  aria-hidden="true"
                />
              </div>
            </Link>
        ...
        <div className="mx-auto w-full max-w-[1240px] px-5 md:px-10">
          ...
          <div className="mt-12 grid grid-cols-2 gap-4 sm:gap-5 md:grid-cols-4">
            {[
              ...
              <div key={s.label} className="rounded-[18px] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-5 text-center backdrop-blur-2xl md:p-7">
                <div className="font-display tab-num text-[44px] font-extrabold leading-none tracking-[-0.025em] text-[var(--primary)] md:text-[56px]">
